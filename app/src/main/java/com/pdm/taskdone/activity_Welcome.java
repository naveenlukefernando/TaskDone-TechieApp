...
public class activity_Welcome extends AppCompatActivity implements OnMapReadyCallback
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                destination = destination.replace(" ", "+"); // relaping space with + for fetch
                Log.d("yeah !", destination);
            ...
            mService.getPath(requestApi)
                    .enqueue(new Callback<String>() {
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(activity_Welcome.this, "" + t.getMessage(), Toast.LENGTH_SHORT).show();
